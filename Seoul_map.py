...
#         # Add NAMED base layers (these make the layer control appear)
#     folium.TileLayer('OpenStreetMap',      name='배경지도: OSM',      show=False).add_to(m)
#     folium.TileLayer('CartoDB positron',   name='배경지도: Positron', show=True).add_to(m)
...
#     top: 10px !important;
#     left: 10px !important;     /* because we used position='topleft' */
...
#     print("Layers attached:",
#     [getattr(c, "layer_name", type(c).__name__)
#     for c in m._children.values() if hasattr(c, "layer_name")])
